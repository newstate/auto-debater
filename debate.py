...
message = client.beta.threads.messages.create(
    thread_id=thread.id,
    role="user",
    content="Stelt u zichzelf alstublieft voor en begin het debat met een stelling over 'kernenergie'. Houdt het debat alstublieft netjes en respectvol maar wees ook kritisch op elkaar waar nodig.",
)
